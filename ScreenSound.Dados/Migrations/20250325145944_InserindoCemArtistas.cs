    ...
    public partial class InserindoCemArtistas : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData("Artistas", new string[] { "Nome", "Bio", "FotoPerfil" }, new object[,] {
                ...
                { "Clara Nunes", "Clara Francisca Gonçalves Pinheiro, conhecida como Clara Nunes, foi uma cantora brasileira, considerada uma das maiores intérpretes da música popular brasileira.","https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png"}
            });
        }
